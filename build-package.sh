...
export "SBT_OPTS=-Xmx8G -Denable-tika=0 -Denable-javacv=0" && \
  sbt desktopApp/universal:packageBin desktopApp/jdkPackager:packageBin && mv -f "./desktop-app/target/universal/shadowcloud-desktop-$VERSION.zip" "./desktop-app/target/universal/shadowcloud-$VERSION-light.zip" && \
