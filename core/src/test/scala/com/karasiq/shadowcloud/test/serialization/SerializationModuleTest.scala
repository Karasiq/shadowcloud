...
class SerializationModuleTest extends FlatSpec with Matchers with TestImplicits {
  testModule("Kryo", SerializationModule.kryo)

  private[this] def testModule(name: String, kryo: SerializationModule): Unit = {
